...
public class INGNepal{
    ...
    public void initializeMenu(){
        ...
        menuItemDeveloper.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                    JOptionPane.showMessageDialog(window,  "DevelopedBy: MK Inc.", "Developer",JOptionPane.INFORMATION_MESSAGE);
                };
            });
    }
    ...
    public void panel1(){
        ...
        btnFTBack.setBounds(350,640,80,30);
    ...
    public void ftAddVacancy(){
        ...
        if(ftVacancy.trim().equals("") || ftDesignation.trim().equals("") || ftJobType.trim().equals("") || ftSalary.trim().equals("") || ftWorkHr.trim().equals("")){
            ...
            try{
                ...
                JOptionPane.showMessageDialog(window,"Please enter data correctly" ,"Error", 0);
                return;
            }
    ...
    public void ftAppoint(){
        ...
        ftAppoint.trim().equals("")){
            ...
            for(int i =0;i<list.size();++i){
                ...
                JOptionPane.showMessageDialog(window,"Vacancy is not entered yet.Please enter the vacacny", "Error",0);
            }
        }
    }
    ...
    public void ftDisplay(){
        ...
        if(join == false){
            JOptionPane.showMessageDialog(window,"Vacancy is not entered yet","Error",0);
        }
    }
    ...
    public void panel2(){
        ...
        btnPTBack.setBounds(300,640,120,30);
        ...
        btnPtTerminate.setBounds(300,595,120,30);
        ...
        btnPtDisplay.setBounds(160,645,120,30);
        ...
        btnPtClear.setBounds(160,680,120,30);
    ...
    public void ptAddVacancy(){
        ...
        ptWagesPerHr.trim().equals("") || ptShifts.trim().equals("")){
            ...
            try{
                ...
                JOptionPane.showMessageDialog(window,"Please enter the data correctly", "Error Message",JOptionPane.ERROR_MESSAGE);
                return;
            }
            for(StaffHire sh: list){
                if (sh instanceof PartTimeStaffHire){
                    ...
                    if(pt.getVacancyNumber()== ptVn){
                        JOptionPane.showMessageDialog(window,"Vacancy Number already entered", "Error",0);
                        return;
                    }
                }
            }
    ...
    public void ptAppoint(){
        ...
        ptQualification.trim().equals("") ||ptAppointedBy.trim().equals("")){
                ...
                if(sh instanceof PartTimeStaffHire){
                    ...
                    if (pt.getVacancyNumber()== ptVn){
                        ...
                        if (pt.getJoined()== true){
                            ...
                            JOptionPane.showMessageDialog(window, " Part Time Staff appointed sucessfully", "Staff appointed",1);
                            break;
                        }
                    }
            ...
            if(join == false){
                JOptionPane.showMessageDialog(window," Vacancy is not entered, enter the vacancy first" ,"Error",0);
            }
        } 
    }
        ...
        for(StaffHire sh: list){
            if(sh instanceof PartTimeStaffHire){
                ...
                if(sh.getVacancyNumber()==ptVn){
                    ...
                    pt.terminateStaff();
                    list.remove(sh);
                    JOptionPane.showMessageDialog(window,"Staff terminated sucessfully","Terminated",1);
                    break;
                }
            }
        }
    ...
    public void ptDisplay(){
        ...
        if(joined== false){
            JOptionPane.showMessageDialog(window,"Vacancy Number is not entered yet","Error",0);
        }
    }
